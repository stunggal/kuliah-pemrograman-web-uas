...
// query tabel
$tampil = query("SELECT * FROM pemesanan, barang where pemesanan.idbarang = barang.idbarang and iduser = '$usr' and status = 'sudah diambil'");
?>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link " href="halamanpesan.php">
                  <span data-feather="gift"></span>
                  Pesanan 
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="halamanpesansiap.php">
                  <span data-feather="shopping-cart"></span>
                  Siap Diambil
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="halamanpesansudah.php">
