...
// query tabel
$tampil = query("SELECT * FROM pemesanan, barang, user where pemesanan.idbarang = barang.idbarang and user.iduser = pemesanan.iduser and status = 'masih disiapkan'");
          ...
          <table class="table table-striped">
            ...
            <form action="" method="post">
              <tr>
                ...
                <td> 
                    <button name="gantikesiap" type="submit" class="btn btn-primary">Sudah Siap</button>
